...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"rs_access_key":                &hcldec.AttrSpec{Name: "rs_access_key", Type: cty.String, Required: false},
		"rs_secret_key":                &hcldec.AttrSpec{Name: "rs_secret_key", Type: cty.String, Required: false},
		"rs_endpoint":                  &hcldec.AttrSpec{Name: "rs_endpoint", Type: cty.String, Required: false},
		"bce_access_key":               &hcldec.AttrSpec{Name: "bce_access_key", Type: cty.String, Required: false},
		"bce_secret_key":               &hcldec.AttrSpec{Name: "bce_secret_key", Type: cty.String, Required: false},
		"region":                       &hcldec.AttrSpec{Name: "region", Type: cty.String, Required: false},
		"endpoint":                     &hcldec.AttrSpec{Name: "endpoint", Type: cty.String, Required: false},
		"src_image_id":                 &hcldec.AttrSpec{Name: "src_image_id", Type: cty.String, Required: false},
		"src_image_type":               &hcldec.AttrSpec{Name: "src_image_type", Type: cty.String, Required: false},
		"src_image_name":               &hcldec.AttrSpec{Name: "src_image_name", Type: cty.String, Required: false},
		"dst_image_name":               &hcldec.AttrSpec{Name: "dst_image_name", Type: cty.String, Required: false},
		"dst_image_version":            &hcldec.AttrSpec{Name: "dst_image_version", Type: cty.String, Required: false},
		"available_zone":               &hcldec.AttrSpec{Name: "available_zone", Type: cty.String, Required: false},
		"instance_spec":                &hcldec.AttrSpec{Name: "instance_spec", Type: cty.String, Required: false},
		"root_disk_type":               &hcldec.AttrSpec{Name: "root_disk_type", Type: cty.String, Required: false},
		"root_disk_size":               &hcldec.AttrSpec{Name: "root_disk_size", Type: cty.Number, Required: false},
		"mount_bns":                    &hcldec.AttrSpec{Name: "mount_bns", Type: cty.String, Required: false},
